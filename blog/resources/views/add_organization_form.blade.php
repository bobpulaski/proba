...
<body>
        ...
        <div class="flex flex-col justify-center sm:w-96 sm:m-auto mx-5 mb-5 space-y-8">
            ...
            <form action="{{ route('organization.add') }}" method="post">
                ...
                <div class="flex flex-col bg-white p-10 rounded-lg shadow space-y-6">
                    <h1 class="font-bold text-xl text-center">Добавить организацию</h1>

                    <div class="flex flex-col space-y-1">
                        <label for="e-mail">Наименование</label>
                        <input type="text" name="name" id="name" class="border-2 rounded px-3 py-2 w-full focus:outline-none focus:border-blue-400 focus:shadow" placeholder="Наименование" />
                    </div>
 ...
 {{--                   <div class="relative">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:justify-between items-center">
                        ...
                        <button type="submit" class="bg-blue-500 text-white font-bold px-5 py-2 rounded focus:outline-none shadow hover:bg-blue-700 transition-colors">Добавить</button>
                    </div>
